...
.Example
	...
	Eicar dropped at C:\My\EicarTest.txt.
            ...
            2021-02-23 21:54:21.543Z | WIN2019\Administrator ran
	C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe, which attempted to access C:\My\EicarTest.txt. The Test
	named EICAR test file was detected and deleted.
...
Get-Content "%LOGDIRECTORY%" -tail 2 -wait | select-string 'EICAR'
